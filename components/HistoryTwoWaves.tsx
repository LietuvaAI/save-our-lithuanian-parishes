...
function ParishSquare({
  ...
  return (
    <Link
      ...
      aria-label={label}
      title={label}
      className={`block size-2 rounded-[1px] transition-transform hover:scale-150 focus:scale-150 focus:outline-none focus:ring-2 focus:ring-foreground ${
  ...
  return (
    <div className="overflow-x-auto pb-1">
      <div className="min-w-[860px]">
        <div className="grid grid-cols-[4.5rem_repeat(15,minmax(0,1fr))] items-end gap-x-[3px]">
          ...
          {decades.map((decade) => (
            <div
              ...
              className="flex min-h-[118px] content-end items-end justify-center"
            >
          ...
          {decades.map((decade) => (
            <div
              ...
              className="flex min-h-[74px] content-start items-start justify-center pt-2"
            >
              <div className="grid grid-cols-4 gap-[3px]">
        ...
        <div className="ml-[4.5rem] mt-2 grid grid-cols-[5fr_3fr_7fr] border-t border-rule text-center font-sans text-ui-label uppercase tracking-widest text-muted">
