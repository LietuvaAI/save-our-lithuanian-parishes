...
**The goods follow the people. **When parishes are merged or divided, church jurisprudence is clear that the parish’s temporal goods — its property, funds, and patrimony — follow the faithful, and decrees must respect the intentions of founders and donors (canons 121–123). For immigrant communities whose churches were built with nickels and dimes, that is not a technicality. It is the legal memory of who paid for the roof.
-
...
Standing up for a parish this way is not standing against the Church. It is asking the Church to follow its own law — the same position this movement takes on [who owns a parish’s property](https://blog.saveourlithuanianparishes.org/p/who-does-the-parish-belong-to).
