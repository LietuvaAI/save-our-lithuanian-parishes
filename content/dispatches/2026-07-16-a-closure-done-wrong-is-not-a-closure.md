...
*Vigil and appeal. Presence and procedure. Neither alone reopened that church; together they did — and the parish they saved was, like ours, an ethnic community defined by a people rather than a map.*
...
Standing up for a parish this way is not standing against the Church. It is asking the Church to follow its own law — the same position this movement takes on [who owns a parish’s property](https://blog.saveourlithuanianparishes.org/p/who-does-the-parish-belong-to). Alignment, not separation.
