...
> **Current-canon note (2026-08-12):** this file locks presentation. Numeric coverage
> snapshots below are historical; current public figures must come from the canonical
> projections and repository validators.
...
## Coverage as of 2026-07-31

- 197 profile pages: 170 parish, 5 misija, 7 congregation, 7 lead, 6 phase, 2 context
- Line art: 34 · photo but no line art: 13 · no imagery at all: 150 (128 of them parish/misija)

Gap list: `line-art-gap.json`.
