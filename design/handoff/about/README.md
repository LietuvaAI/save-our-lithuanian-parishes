...
| Jonynas stained-glass window, Divine Providence | project-owner photograph by Vilija Jurgutienė | `permission_granted` by the photographer/project owner | ready after a governed local copy and `photos.json` entry are added; credit **"Photo by Vilija Jurgutienė"** |
