...
- **Counts:** 211 canonical records after Registry Revision 3: 196 `parish`, 1 historical `phase`, 4 `misija`, and 10 `congregation` records. The 83 historical U.S. case-file rows remain explicitly accounted for across 82 unique case-filed entities (`c83_rows`), because the false Waterbury St. Casimir row remains merged into St. Joseph. Worcester, Wilkes-Barre, and DuBois each lost one duplicate shell; Providence remains visible as phase evidence without inflating the durable-parish count.
