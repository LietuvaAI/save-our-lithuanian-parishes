...
- **Role after Registry Revision 9:** This is the site display layer for narrative, lifecycle, geography, media, and source detail. Public census fields are synchronized from `canonical-publication-projection.json`; this file cannot independently add, remove, merge, or reclassify a public institution.
