...
- **Canonical source as of Registry Revision 2 (2026-07-27): this file in `LietuvaAI/save-our-lithuanian-parishes`.** `LietuvaAI/culturenet-brain` retains the pinned builder, final upstream snapshot, exclusions/ambiguity artifacts, and page-cited research provenance; subsequent research enters here by held PR. This is the agreed canonical-home move, not a fork.
- **Revision 2 evidence packet:** `culturenet-brain/docs/research/elip-2026/adjudications.md`. The revision corrects four Scranton/Wilkes-Barre closure identities and dates, resolves Nanticoke/Hanover as one entity closed in 2001, and separates Minersville's 2020 church-building closure from its unresolved juridic parish-end date. The replayable application and human-readable diff are `scripts/apply-registry-revision2-elip.mjs` and `data/candidates/registry-revision-2-elip-report.md`.
...
- **Counts:** 214 canonical records after the merge: 200 `parish`, 4 `misija`, and 10 `congregation` records. The 83 historical U.S. case-file rows remain explicitly accounted for across 82 unique case-filed entities (`c83_rows`), because the false Waterbury St. Casimir row is now merged into St. Joseph. The previous enriched site snapshot held 223 records; the nine-record reduction is exactly Westville -2, Kearny/Harrison -4, Chicago Heights -1, Baltimore -1, and Waterbury -1.
